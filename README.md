...
[![.NET](https://github.com/STS-Mining/miningcore/actions/workflows/dotnet.yml/badge.svg)](https://github.com/STS-Mining/miningcore/actions/workflows/dotnet.yml)
[![license](https://img.shields.io/github/license/mashape/apistatus.svg)]()

<img src="https://github.com/STS-Mining/miningcore/raw/master/logo.png" width="150">
...
For general questions visit the [Discussions Area](https://github.com/STS-Mining/miningcore/discussions).

## Contributions

Code contributions are very welcome and should be submitted as standard [pull requests](https://docs.github.com/en/pull-requests) (PR) based on the [`dev` branch](https://github.com/STS-Mining/miningcore/tree/dev).

## Building on Debian/Ubuntu

```console
git clone https://github.com/STS-Mining/miningcore
cd miningcore
```
...
Windows is **not** a supported production environment. Only Linux is. Please do not file issues related to running a pool on Windows. Windows topics should be posted under [discussions](https://github.com/STS-Mining/miningcore/discussions).
...
Refer to [this file](https://github.com/STS-Mining/miningcore/blob/master/src/Miningcore/coins.json) for a complete list.
...
To support this project you can become a [sponsor]( https://github.com/sponsors//STS-Mining ) or send a donation to the following accounts:
